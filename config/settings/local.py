...
SECRET_KEY = env(
    "DJANGO_SECRET_KEY",
    default="ekJLnKx8JwQzm2TRWasM6R7vDpoG5lSxrfLSW4UEgOCvHDn5aAWRQnJNr370j3jH",
)
...
MIDDLEWARE = ["whitenoise.middleware.WhiteNoiseMiddleware"] + MIDDLEWARE + ["debug_toolbar.middleware.DebugToolbarMiddleware"]
